...
const Appointment = () => {
  ...
  const handleSlot = (slot) => {
    if (slot == "8:00 AM") slot = 8;
    if (slot == "9:00 AM") slot = 9;
    if (slot == "10:00 AM") slot = 10;
    if (slot == "11:00 AM") slot = 11;
    if (slot == "1:00 PM") slot = 13;
    if (slot == "2:00 PM") slot = 14;
    if (slot == "3:00 PM") slot = 15;
    if (slot == "4:00 PM") slot = 16;
    return slot;
  };
  const handleDuocCheckIn = (slot) => {
    if (dayjs().hour() == slot) {
      ...
      if (dayjs().hour() - slot == -1) {
        ...
        if (dayjs().hour() > slot) return "not future";
        else {
          return "not pass";
        }
      }
                ...
                return (
                  <TableRow key={i} hover>
                    ...
                    <TableCell align="center">
                      {formatDateMonthYear(user?.dateBooking)}
                    </TableCell>
                    <TableCell align="center">{user?.slotBooking}</TableCell>
